 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),nativeReduce=Array.prototype.reduce,reduceCoercesToObject=!1;if(nativeReduce)try{reduceCoercesToObject="object"==typeof nativeReduce.call("es5",function(_,__,___,list){return list})}catch(ignore){nativeReduce=null}var $reduce;if(nativeReduce&&reduceCoercesToObject)$reduce=function reduce(array,callBack){var object=toObject(array),args=[callBack];return arguments.length>2&&args.push(arguments[2]),nativeReduce.apply(object,args)};else{var boxedString=Object("a"),splitString="a"!==boxedString[0]||0 in boxedString==!1,assertIsFunction=_dereq_("assert-is-function-x"),isString=_dereq_("is-string"),toLength=_dereq_("to-length-x"),errMsg="reduce of empty array with no initial value";$reduce=function reduce(array,callBack){var object=toObject(array);assertIsFunction(callBack);var iterable=splitString&&isString(object)?object.split(""):object,length=toLength(iterable.length);if(0===length&&2===arguments.length)throw new TypeError(errMsg);var result,i=0;if(arguments.length>2)result=arguments[2];else for(;;){if(i in iterable){result=iterable[i],i+=1;break}if((i+=1)>=length)throw new TypeError(errMsg)}for(;i<length;)i in iterable&&(result=callBack(result,iterable[i],i,object)),i+=1;return result}}module.exports=$reduce},{"assert-is-function-x":2,"is-string":15,"to-length-x":27,"to-object-x":28}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";module.exports=_dereq_("has-symbol-support-x")&&"symbol"==typeof Symbol.toStringTag},{"has-symbol-support-x":5}],7:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isString=_dereq_("is-string"),STRIP_COMMENTS=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;module.exports=function replaceComments(string){var replacement=arguments.length>1&&isString(arguments[1])?arguments[1]:"";return isString(string)?string.replace(STRIP_COMMENTS,replacement):""}},{"is-string":15}],24:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNil=_dereq_("is-nil-x");module.exports=function RequireObjectCoercible(value){if(isNil(value))throw new TypeError("Cannot call method on "+value);return value}},{"is-nil-x":13}],25:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isSymbol=_dereq_("is-symbol"),pToString=_dereq_("has-symbol-support-x")&&Symbol.prototype.toString;module.exports=function safeToString(value){return pToString&&isSymbol(value)?pToString.call(value):String(value)}},{"has-symbol-support-x":5,"is-symbol":16}],26:[function(_dereq_,module,exports){/**
 ...
 * @module to-integer-x
 */
"use strict";var $isNaN=_dereq_("is-nan"),$isFinite=_dereq_("is-finite-x"),$sign=_dereq_("math-sign-x");module.exports=function ToInteger(value){var number=Number(value);return $isNaN(number)?0:0===number||!1===$isFinite(number)?number:$sign(number)*Math.floor(Math.abs(number))}},{"is-finite-x":7,"is-nan":10,"math-sign-x":18}],27:[function(_dereq_,module,exports){/**
 ...
 * @module to-length-x
 */
"use strict";var toInteger=_dereq_("to-integer-x"),MAX_SAFE_INTEGER=_dereq_("max-safe-integer");module.exports=function ToLength(value){var len=toInteger(value);return len<=0?0:len>MAX_SAFE_INTEGER?MAX_SAFE_INTEGER:len}},{"max-safe-integer":19,"to-integer-x":26}],28:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr=Object.prototype.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":17,"validate.io-undefined":34}],30:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return String(value)}},{"is-symbol":16}],31:[function(_dereq_,module,exports){/**
